...
/**
 * Generated class for the NorProContactPage page.
 *
...
@IonicPage()
@Component({
  selector: "page-nor-pro-contact",
  templateUrl: "nor-pro-contact.html"
})
export class NorProContactPage {
  date: any;
  daysInThisMonth: any;
  daysInLastMonth: any;
  daysInNextMonth: any;
  ...
  openFacebook() {
    this.inAppBrowser.create(
      "https://www.facebook.com/people/Bryan-Arzate/100006558072816"
    );
  }
}
