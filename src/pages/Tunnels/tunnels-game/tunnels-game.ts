...
import { TunnelsGameDonePage } from "../tunnels-game-done/tunnels-game-done";

declare var Phaser: any;
@IonicPage()
@Component({
  selector: "page-tunnels-game",
  templateUrl: "tunnels-game.html"
})
export class TunnelsGamePage {
  ...
  game1(deviceMotion) {
    ...
    function preload() {
      //LOAD IMAGES
      this.game.load.image("bg", "assets/tunnels/back.png");
      this.game.load.image("phaser", "assets/tunnels/circle.png");
      this.game.load.image("2", "assets/tunnels/imgs/2.png");
      this.game.load.image("3", "assets/tunnels/imgs/3.png");
      this.game.load.image("4", "assets/tunnels/imgs/4.png");
      this.game.load.image("5", "assets/tunnels/imgs/5.png");
    }
    ...
    function create() {
      ...
      self.bg = this.game.add.sprite(0, 0, "bg");
      this.game.physics.arcade.enable(self.bg);
      self.bg.height = window.innerHeight;
      self.bg.width = window.innerWidth;
      // adds ball sprite to the game
      self.sprite = this.game.add.sprite(
        window.innerWidth / 2,
      ...
      console.log(self.bg.height);
      console.log(self.sprite.height);
      ...
      this.tunnel2.width = 129;

      this.tunnel3 = this.game.add.sprite(
        window.innerWidth - 129,
        window.innerHeight / 2 - 28,
        "3"
      );
      this.game.physics.arcade.enable(this.tunnel3);
      this.tunnel3.height = 75;
      this.tunnel3.width = 129;

      this.tunnel4 = this.game.add.sprite(
        window.innerWidth / 2 - 28,
        window.innerHeight - 129,
        "4"
      );
      this.game.physics.arcade.enable(this.tunnel4);
      this.tunnel4.height = 129;
  ...
  game2(deviceMotion) {
    ...
    function preload() {
      ...
      this.game.load.image("bg", "assets/tunnels/back.png");
      this.game.load.image("phaser", "assets/tunnels/circle.png");
      this.game.load.image("2", "assets/tunnels/imgs/13.png");
      this.game.load.image("3", "assets/tunnels/imgs/11.png");
      this.game.load.image("4", "assets/tunnels/imgs/12.png");
      this.game.load.image("5", "assets/tunnels/imgs/14.png");
    }
  ...
  game3(deviceMotion) {
    ...
    function preload() {
      ...
      this.game.load.image("bg", "assets/tunnels/back.png");
      this.game.load.image("phaser", "assets/tunnels/circle.png");
      this.game.load.image("2", "assets/tunnels/imgs/10.png");
      this.game.load.image("3", "assets/tunnels/imgs/9.png");
      this.game.load.image("4", "assets/tunnels/imgs/8.png");
      this.game.load.image("5", "assets/tunnels/imgs/7.png");
    }
  ...
  game4(deviceMotion) {
    ...
    function preload() {
      ...
      this.game.load.image("bg", "assets/tunnels/back.png");
      this.game.load.image("phaser", "assets/tunnels/circle.png");
      this.game.load.image("2", "assets/tunnels/imgs/17.png");
      this.game.load.image("3", "assets/tunnels/imgs/16.png");
      this.game.load.image("4", "assets/tunnels/imgs/15.png");
      this.game.load.image("5", "assets/tunnels/imgs/18.png");
    }
  ...
  gameDone() {
    ...
    this.navCtrl.push(TunnelsGameDonePage);
  }
}
